...
public class NewGame extends javax.swing.JFrame {
    ...
    public NewGame(Menu menu) {
        if (Engine.selectedProfile.equals("<No Profile Loaded>")) {
            ...
            System.out.println("NewGame selected profile");
            initComponents();
            setFields();
            setCrazy();
        }
    ...
    private void initComponents() {
        ...
        jRadioButton1.setFont(new java.awt.Font("Chiller", 0, 20)); // NOI18N
        ...
        jRadioButton2.setFont(new java.awt.Font("Chiller", 0, 20)); // NOI18N
        ...
        jRadioButton3.setFont(new java.awt.Font("Chiller", 0, 20)); // NOI18N
        ...
        jRadioButton4.setFont(new java.awt.Font("Chiller", 0, 20)); // NOI18N
...
// TODO add your handling code here:
    ...
    System.out.println("Button clicked, startGame");
    startGame(1, Engine.selectedProfile, dificultad);
//    System.out.println("Setting Menu's control to false");
    menu.setControl(false);
//    System.out.println("Disposing NewGame");
    menu.setShouldCloseMenu(true);
    //menu.dispose();
    this.dispose();
