...
public class Console extends javax.swing.JFrame {
    ...
    private static String hackerName = Engine.selectedProfile;
    private static String email = "";
    private HashMap<String, Integer> cmdList = new HashMap();
...
private void formKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_formKeyPressed
    ...
    public void checkCmd(String cmd) {
        ...
        if (cmd.equals("help")) {
            ...
            readmail();
        } else if (cmd.contains("install") && cmd.substring(0, 7).equals(
                "install")) {
            install(cmd.replace("install", ""));
        } else if (cmd.contains("sendpass") && cmd.substring(0, 8).equals(
                "sendpass")) {
    ...
    public void install(String s) {
        ...
        if (s.equals("binary")) {
            if (cd) {
                ...
                outputArea.append(
                        "La Contraseña es el numero " + n + " en binario: \nUtiliza el comando\"sendpass\"\n");
            } else {
                if (challenge) {
                    outputArea.append(
    ...
    public void setFloppy(final boolean floppy) {
        this.floppy = floppy;
    }

    public void setSd(final boolean sd) {
        this.sd = sd;
    }
    ...
    public void ftp(final String s) {
        if (s.equals("")) {
            outputArea.setText(
